...
import EachPhysioShebaBooking from '../components/EachPhysioShebaBooking';
import {useNavigation} from '@react-navigation/native';
import AsyncStorage from '@react-native-async-storage/async-storage';
import axios from 'axios';

const renderAllTest = ({item}) => <EachPhysioShebaBooking item={item} />; 

const PhysioShebaBookingListScreen = () => {
...
const getNotificationType = () => {
 try {
  ...
  const fetchAllTest = () => {
    try {
      const api =
        'https://www.api-care-box.click/api/v2/physio_care/get_physiotherapy_booking_admin_api/';
      axios
        .get(api, {
          headers: {
...
export default PhysioShebaBookingListScreen;
