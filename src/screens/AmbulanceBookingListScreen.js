...
import EachAmbulanceBooking from '../components/EachAmbulanceBooking'
import {useNavigation} from '@react-navigation/native';
import AsyncStorage from '@react-native-async-storage/async-storage';
import axios from 'axios';

const renderAllTest = ({item}) => <EachAmbulanceBooking item={item} />; 

const AmbulanceBookingListScreen = () => {
...
const getNotificationType = () => {
 try {
  ...
  const fetchAllTest = () => {
    try {
      const api =
        'https://www.api-care-box.click/api/v2/ambulance/get_ambulance_booking_admin_api/';
      axios
        .get(api, {
          headers: {
...
export default AmbulanceBookingListScreen;
