...
const EachAmbulanceBooking = ({item}) => {
  ...
  return (
    <>
      ...
      <View
        ...
        <View style={{justifyContent: 'space-around',width:'60%',paddingLeft:10}}>
          ...
          />
         <Text>PickUp Adress:{item.pickupAddress}</Text>
         <Text>Drop Adress:{item.dropAddress}</Text>
        </View>
        ...
        <View style={{padding: 20, flex: 1, justifyContent: 'space-around'}}>
          ...
          Total Amount :
          <Text style={{color: '#BD0451'}}>{item.totalBill}</Text>
        </Text>:
        <Text style={{color: 'black'}}>
        Total Amount :
        <Text style={{color: '#BD0451'}}>0</Text>
      </Text>
          ...
          <TouchableOpacity
            ...
            <Text style={{color: 'white', fontSize: 14}}>{item.orderStatus}</Text>
          </TouchableOpacity>
        </View>
      </View>
...
export default EachAmbulanceBooking;
